...
using ChoiceWeb.Models;
using ChoiceWeb.Models.ViewModels;
using ChoiceWeb.Providers;
using ChoiceWeb.Results;

namespace ChoiceWeb.Controllers
{
    [Authorize]
    ...
    public class AccountServiceController : ApiController
    {
        ...
        public AccountServiceController(UserManager<IdentityUser> userManager,
